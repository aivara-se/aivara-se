...
<article>
	...
	<p>
		Aivara is a software development company absed in Knivsta, Sweden. This privacy policy will
		explain how our organization uses the personal data we collect from you when you use our
		website.
	</p>
	<p>Topics:</p>
	<ul>
	...
	<p>Aivara collects the following data:</p>
	<ul>
		<li>Personal identification information (Name, email address, phone number, etc.)</li>
	</ul>
	<h3>How do we collect your data?</h3>
	<p>
		You directly provide Aivara with most of the data we collect. We collect data and process data
		when you:
	</p>
	<ul>
	...
	<p>Aivara collects your data so that we can:</p>
	<ul>
		<li>Process your requests</li>
	</ul>
	<p>
		When Aivara processes your order, it may send your data to, and also use the resulting
		information from, credit reference agencies to prevent fraudulent purchases.
	</p>
	<h3>How do we store your data?</h3>
	<p>Aivara securely stores your data on servers operated by Google.</p>
	<p>
		Aivara will keep your contact details for up to a year after processing your request. Once this
		time period has expired, we will delete your data.
	</p>
	<h3>What are your data protection rights?</h3>
	<p>
		Aivara would like to make sure you are fully aware of all of your data protection rights. Every
		user is entitled to the following:
	</p>
	<p>
		<strong>The right to access</strong> – You have the right to request Aivara for copies of your personal
	...
	<p>
		<strong>The right to restrict processing</strong> – You have the right to request that Aivara restrict
		the processing of your personal data, under certain conditions.
	</p>
	<p>
		<strong>The right to object to processing</strong> – You have the right to object to Aivara’s processing
		of your personal data, under certain conditions.
	</p>
	<p>
		<strong>The right to data portability</strong> – You have the right to request that Aivara transfer
	...
	<p>
		Aivara uses cookies in a range of ways to improve your experience on our website, including:
	</p>
	<ul>
	...
	<p>
		The Aivara website contains links to other websites. Our privacy policy applies only to our
		website, so if you click on a link to another website, you should read their privacy policy.
	</p>
	<h3>Changes to our privacy policy</h3>
	<p>
		Aivara keeps its privacy policy under regular review and places any updates on this web page.
